...
self.getMap().addControl(new google.maps.LargeMapControl3D(),new GControlPosition(G_ANCHOR_TOP_LEFT,new google.maps.Size(0,30)));
self.OverviewMapControl=new google.maps.OverviewMapControl();
self.getMap().addControl(self.OverviewMapControl,new GControlPosition(G_ANCHOR_TOP_LEFT));
self.getMap().addControl(new google.maps.HierarchicalMapTypeControl(),new GControlPosition(G_ANCHOR_TOP_LEFT));
